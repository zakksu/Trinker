...
from src.build_orders.detailed_builds import (
    britons_archer_rush_detailed,
    fast_castle_any_detailed,
)
from src.build_orders.manager import (
    delete_build_order,
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            step(
                1,
                "6 villagers → sheep (under TC)",
                "0:00",
                4,
                notes="Queue villagers non-stop from TC",
            ),
            ...
            step(
                ...
                "1:30",
                10,
                notes="Move off sheep as they deplete",
            ),
            step(4, "11th vill → build Lumber Camp, then wood", "2:30", 11, wood=3),
            step(5, "12th–14th vill → wood", "3:10", 14, wood=6),
            step(
                6,
                "15th vill → build Mill → berries",
                "4:00",
                15,
                notes="Lure 2nd boar before Mill fills",
            ),
            step(7, "16th–17th vill → berries (under Mill)", "4:30", 17),
            step(8, "18th vill → farm under TC", "5:30", 18, food=6, wood=6),
            step(
                9,
                "Research Double-Bit Axe when 200 wood",
                "6:00",
                18,
                notes="Also research Horse Collar when wheat/food available",
            ),
            step(
                10,
                "Click Feudal Age (use 500F / 800F → depends on timing, standard 800F+240G)",
                "7:00",
                18,
            ...
            step(
                11,
                "3 vills → build Barracks + Stable during Feudal transition",
                "7:00",
                18,
            ...
            step(
                12,
                "Queue 3–4 Scouts from Stable upon reaching Feudal (~9:30)",
                "9:30",
                21,
                age="Feudal",
                notes="Send scouts to enemy base. Target vills on wood/gold",
            ),
            step(
                13,
                "All new vills → gold (3–4) + remaining → farms",
                "9:30",
                22,
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                8,
                "19th–21st vill → gold (3 vills gold)",
                "5:30",
                21,
                gold=3,
                notes="Prepare gold for Castle Age",
            ),
            step(
                9,
                "Click Feudal Age (~9:00–9:30)",
                "7:30",
                21,
                notes="500F/800F standard",
            ),
            step(10, "Build Barracks + Stable during Feudal up", "7:30", 21),
            step(
                11,
                "Reach Feudal. Queue 3 Scouts. Research Bloodlines.",
                "9:30",
                23,
                age="Feudal",
                notes="Bloodlines is huge DPS increase; always research first",
            ),
            step(
                12,
                "New vills → farms + gold. Click Castle at 800F/200G",
                "11:00",
                25,
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                9,
                "Click Feudal Age at ~500F",
                "7:00",
                22,
                notes="800F timing is also fine for slower Feudal",
            ),
            step(
                10,
                "Build Barracks + Archery Range during Feudal up",
                "7:00",
                22,
            ...
            step(
                11,
                "Reach Feudal. Immediately start queueing Archers.",
                "9:30",
                24,
                age="Feudal",
                notes="Keep 2–3 vills on gold for continuous arrow production",
            ),
            step(
                12,
                "Research Fletching ASAP (3-shot vills)",
                "10:00",
                25,
            ...
            step(
                13,
                "Build 2nd Archery Range at 20 archers",
                "11:00",
                27,
            ...
            step(
                14,
                "New vills → gold (5–6) + farms. Save for Castle at 800F/200G",
                "12:00",
                29,
            ),
        ],
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                9,
                "At ~200G build Barracks. Click Feudal at ~4:30.",
                "4:30",
                22,
            ...
            step(
                10,
                "Research Man-at-Arms immediately upon reaching Feudal (140F/60G)",
                "9:30",
                22,
                age="Feudal",
                notes="Queue 2–4 Militia immediately from Barracks",
            ),
            step(11, "Build Archery Range. Start queueing Archers.", "9:30", 24),
            step(
                12,
                "Send M@A to enemy base. Harass vills at wood/gold.",
                "10:00",
                25,
            ...
            step(
                14,
                "Click Castle at 800F/200G. Transition to archer-knight combo.",
                "14:00",
                30,
            ),
        ],
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                7,
                "Click Feudal at ~800F (delayed, no rush)",
                "9:00",
                22,
            ...
            step(
                8,
                "Reach Feudal. Click Castle ASAP. Keep all vills on eco.",
                "11:00",
                25,
                age="Feudal",
            ),
            step(
                9,
                "Build 2nd Town Center immediately upon Castle Age",
                "16:00",
                30,
                age="Castle",
                notes="400 Wood 200 Stone. Place near extra resources.",
            ),
            step(
                10,
                "Build 3rd TC at ~35 pop. Research Wheelbarrow.",
                "18:00",
                35,
            ...
            step(
                12,
                "In Imperial: build University, Chemistry, Siege Workshop.",
                "25:00",
                70,
                age="Imperial",
                notes="Your massive eco advantage converts to military superiority",
            ),
        ],
    )
)
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                7,
                "Build Barracks at ~2:30 with 2 wood vills temporarily",
                "3:30",
                16,
            ...
            step(
                8,
                "Queue 3 Militia. Drush leaves at ~5:30",
                "5:30",
                16,
            ...
            step(
                10,
                "Send 3 Militia to enemy wood line or berries",
                "5:30",
                16,
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                9,
                "Reach Feudal. Queue Scouts. They are 30% faster!",
                "9:30",
                21,
                age="Feudal",
                notes="Mongol scouts can dodge towers and outrun almost everything",
            ),
            step(10, "3 vills → gold. Research Bloodlines.", "9:30", 22, gold=3),
            step(
                11,
                "Keep queueing scouts. 4–6 scouts = unstoppable harassment.",
                "10:00",
                24,
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                9,
                "Reach Feudal. Click Castle Age immediately.",
                "11:00",
                25,
                age="Feudal",
            ...
            step(
                10,
                "Build 2 Stables + extra farms during Castle up",
                "11:00",
                26,
                gold=6,
                notes="Bring gold to 6–7 vills",
            ),
            step(
                11,
                "Reach Castle. Flood Knights — Franks have free Bloodlines!",
                "16:00",
                30,
                age="Castle",
                notes="Franks: knights have +40 HP. Research Forging, Iron Casting ASAP",
            ),
            step(
                12,
                "Add 3rd Stable. Destroy enemy with Knight mass.",
                "18:00",
                35,
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            step(
                1,
                "7 vills → sheep (Mayans start with extra eagle, +1 food per vill bonus)",
                "0:00",
                5,
            ...
            step(
                8,
                "Build Barracks + 2x Archery Ranges during Feudal up",
                "7:00",
                22,
            ...
            step(
                9,
                "Reach Feudal. Double Archery Range production immediately.",
                "9:30",
                24,
                age="Feudal",
                notes="Mayan archers have +20% HP. Fletching first.",
            ),
            ...
            step(
                12,
                "Click Castle at 800F/200G. Research El Dorado (Eagle Warriors +40HP).",
                "14:00",
                30,
                age="Castle",
            ),
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            step(
                1,
                "6 vills → sheep (NO HOUSES NEEDED — Huns bonus)",
                "0:00",
                4,
            ...
            step(
                8,
                "Reach Feudal. Click Castle immediately.",
                "11:00",
                27,
                age="Feudal",
            ...
            step(
                9,
                "Reach Castle. Click Imperial immediately (1000F/800G).",
                "16:00",
                30,
                age="Castle",
                notes="During Castle: build 2 Stables or range (defensive), no wasted time",
            ),
            step(
                10,
                "Build Stables + Siege Workshop upon Imperial.",
                "23:00",
                45,
                age="Imperial",
                notes="Tarkan + Trebs or Paladin + Siege",
            ),
            step(
                11,
                "Research all eco upgrades. Build battering rams. Push.",
                "25:00",
                50,
            ),
        ],
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                4,
                "13th–15th vill → stone (Koreans: towers need stone, cheaper by 25%)",
                "3:00",
                15,
                stone=3,
                notes="Korean towers cost 125 stone instead of 150",
            ),
            step(5, "16th–17th vill → berries (Mill)", "4:00", 17),
            step(
                6,
                "Send 3–4 vills to enemy base at ~5:30 (before Feudal)",
                "5:30",
                17,
            ...
            step(
                8,
                "Reach Feudal. Send building vills from step 6 to build towers.",
                "9:00",
                19,
                age="Feudal",
                notes="Build Watch Tower next to their wood line or gold",
            ),
            step(
                9,
                "Korean Watch Tower has +1 range over normal. Extra deadly.",
                "9:30",
                20,
            ...
            step(
                10,
                "Build 2nd tower near their TC. Force them to fight or die.",
                "10:00",
                21,
            ...
            step(
                11,
                "Back home: click Castle. Build range/stable for defense.",
                "10:30",
                23,
            ),
            step(
                12,
                "Reach Castle. Research Architecture → Towers become Bombard-ready.",
                "16:00",
                28,
                age="Castle",
            ),
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            ...
            step(
                5,
                "17th–20th vill → wood (wall building starts ~4:30)",
                "4:30",
                20,
                wood=7,
            ...
            step(
                9,
                "Reach Feudal. Finish walling. Click Castle ASAP.",
                "11:00",
                25,
                age="Feudal",
            ...
            step(
                10,
                "Reach Castle. Drop 2nd TC near new resources.",
                "16:00",
                30,
                age="Castle",
                notes="400 wood 200 stone — place near secondary gold/stone",
            ),
...
BUILDS.append(
    BuildOrder(
        ...
        steps=[
            step(
                1,
                "6 vills → sheep (Aztecs start with extra resources)",
                "0:00",
                4,
                food=6,
            ),
            ...
            step(
                8,
                "Queue 4 Militia. Send them together at ~5:30.",
                "5:30",
                18,
            ...
            step(
                10,
                "Click Feudal at ~22 pop. Research Man-at-Arms upgrade.",
                "7:30",
                22,
                age="Feudal",
                notes="M@A research costs 140F/60G",
            ),
            step(
                11,
                "Build Archery Range. Queue archers for follow-up.",
                "9:30",
                24,
                age="Feudal",
            ),
            step(
                12,
                "Push enemy base with 4 M@A. Aztec units are hard to kill.",
                "10:00",
                24,
            ...
            step(
                14,
                "Reach Castle. Research Eagle Warrior or Jaguar Warrior line.",
                "16:00",
                32,
                age="Castle",
            ),
